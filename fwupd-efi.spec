...
Version  : 1.2
Release  : 2
URL      : https://github.com/fwupd/fwupd-efi/archive/1.2/fwupd-efi-1.2.tar.gz
Source0  : https://github.com/fwupd/fwupd-efi/archive/1.2/fwupd-efi-1.2.tar.gz
...
%prep
%setup -q -n fwupd-efi-1.2
cd %{_builddir}/fwupd-efi-1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643053762
...
cp %{_builddir}/fwupd-efi-1.2/COPYING %{buildroot}/usr/share/package-licenses/fwupd-efi/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/fwupd-efi-1.2/contrib/debian/copyright %{buildroot}/usr/share/package-licenses/fwupd-efi/025d2aafdf57cdf11ed493d11d40ab0a4901a20f
cp %{_builddir}/fwupd-efi-1.2/contrib/debian/signing-template/copyright %{buildroot}/usr/share/package-licenses/fwupd-efi/c1a12b921301c21ba9b3dc26e7db1d859bb8259d
