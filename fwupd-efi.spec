...
Version  : 1.3
Release  : 3
URL      : https://github.com/fwupd/fwupd-efi/archive/1.3/fwupd-efi-1.3.tar.gz
Source0  : https://github.com/fwupd/fwupd-efi/archive/1.3/fwupd-efi-1.3.tar.gz
...
%prep
%setup -q -n fwupd-efi-1.3
cd %{_builddir}/fwupd-efi-1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672173438
